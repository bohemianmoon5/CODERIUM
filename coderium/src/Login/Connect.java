			...
			btn.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (result == JOptionPane.YES_OPTION) {
						...
						if (seat.get(0) != null) {
							JOptionPane.showMessageDialog(null, "<html><font face="+font+">이미 좌석이 있습니다.</font></html>",
			...
			btn.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					int result = JOptionPane.showConfirmDialog(null,
							"<html><center><font face = "+font+"> 예약 하시겠습니까? </font></center></html>", "confirm",
		...
		public void inEvent(JButton btn) {
			btn.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					int result = JOptionPane.showConfirmDialog(null, "<html><font face="+font+">입실하시겠습니까?</font></html>",
					...
					if (result == JOptionPane.YES_OPTION) {
						...
						if (data.size() == 1) {
							JOptionPane.showMessageDialog(null, "<html><font face="+font+">입실되었습니다.</font></html>",
							...
							JOptionPane.showMessageDialog(null, "<html><font face="+font+">입실할 수 없는 사용자입니다.</font></html>",
									"Message", result, null);
						}
		...
		public void outEvt(JButton btn) {
			btn.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					int result = JOptionPane.showConfirmDialog(null, "<html><font face="+font+">퇴실하시겠습니까?</font></html>",
							"confirm", JOptionPane.YES_NO_OPTION);
					if (result == JOptionPane.YES_OPTION) {
		...
		public void seatChangeEvt(JButton btn) {
			btn.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					int result = JOptionPane.showConfirmDialog(null, "<html><font face="+font+">바로 사용하시겠습니까?</font></html>",
							"confirm", JOptionPane.YES_NO_OPTION);
					if (result == JOptionPane.YES_OPTION) {
						MainF mf = new MainF();
						db d = new db();
		...
		public void timeEvt(JButton btn) {
			btn.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					int result = JOptionPane.showConfirmDialog(null,
							"<html><font face="+font+">시간을 확인하시겠습니까.?</font></html>", "confirm", JOptionPane.YES_NO_OPTION);
					if (result == JOptionPane.YES_OPTION) {
						MainF mf = new MainF();
						db d = new db();
						...
						if (startTime.get(0) != null & endTime.get(0) != null)
							JOptionPane.showMessageDialog(null, "<html><left>"
									+ "<font face="+font+"> 좌석번호는</font> <font color='red', size = 15, face = "+font+">"
									+ seat.get(0) + "</font>번" + "<br>"
									+ "<font color = 'blue', size = 16, face = "+font+">" + startTime.get(0)
									+ "</font> ~ <font color = 'blue', size = 16, face = "+font+">" + endTime.get(0)
									+ "</font>까지", "confirm", JOptionPane.INFORMATION_MESSAGE);
						else {
							JOptionPane.showMessageDialog(null, "<html><font face="+font+">결제 부탁 드립니다.</font><html>",
									"confirm", JOptionPane.INFORMATION_MESSAGE);
						}
