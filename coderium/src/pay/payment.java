...
import login.MainF;
import pay.done;
import pay.component.fighting;
import pay.component.nextBtn;
import pay.component.product;
import pay.component.showDetail;
import pay.data.modiData;
import pay.data.reservData;
import pay.data.storeData;
import pay.event.windowEvent;
import pay.panel.cashPanel;
import pay.panel.detailPanel;
...
//		we.event();
	...
	public static void setPayCash(int payCash) {
	...
	public void makeCashPanel() {
		...
		cp.create(fakeFrame);
		System.out.println("pay!!!" + getPayCash());
	}
...
//				fakeFrame("card");
	...
	Consumer<String> fakeFrame = type -> {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
//					System.out.println(mustCash);
//					System.out.println(payCash);
					done d = new done(mustCash, getPayCash());
