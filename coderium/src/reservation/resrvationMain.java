...
//			setFrame(frame);						
		...
		frame.getContentPane().setFont(new Font("twayair", Font.BOLD, 20));
...
//		frame.getContentPane().setLayout(null);
		...
		icon = new ImageIcon("./src/image/new.png");
...
//				btn_pay.setvisible(false);  => 결제 버튼 비활성화 활성화 하고 싶은데 순서가 문제다 고민해보자,,,!
		...
		btn_checkRe.setFont(new Font("twayair", Font.BOLD, 25));
		...
		btn_cancelRe.setFont(new Font("twayair", Font.BOLD, 25));
...
//		frame.getContentPane().add(createNewRe);
		...
		LavelnewRe.setFont(new Font("twayair", Font.BOLD, 30));
		LavelnewRe.setBounds(0, 0, 714, 110);
		panel.add(LavelnewRe);

		JLabel date = new JLabel("날짜");
		date.setHorizontalAlignment(SwingConstants.CENTER);
		date.setFont(new Font("twayair", Font.BOLD, 30));
		...
		time.setFont(new Font("twayair", Font.BOLD, 30));
		...
		seat.setFont(new Font("twayair", Font.BOLD, 30));
		seat.setBounds(10, 775, 200, 80);
		panel.add(seat);

		// 새로운 예약 => 좌석표 선택창 오픈 버튼
		btn_seat = new JButton("좌석 선택");
		btn_seat.setFont(new Font("twayair", Font.BOLD, 25));
...
//		btn_seat.setBounds(250, 600, 221, 54);
		...
		btn_pay.setFont(new Font("twayair", Font.BOLD, 25));
...
//		btn_pay.setBorder(new LineBorder(Color.BLUE));
	...
	public void checkRe(JPanel panel) {
		...
		LavelcheckRe.setFont(new Font("twayair", Font.BOLD, 30));
		LavelcheckRe.setBounds(0, 0, 714, 110);
		panel.add(LavelcheckRe);

		// 예약 확인 => 입실 버튼 활성화
		JButton btn_checkIn = new JButton("입실");
		btn_checkIn.setFont(new Font("twayair", Font.BOLD, 25));
	...
	public void cancelRe(JPanel panel) {
		...
		LavelcancelRe.setFont(new Font("twayair", Font.BOLD, 30));
		...
		btn_reCancel.setFont(new Font("twayair", Font.BOLD, 25));
...
//    }
	...
	public void btn_back(JPanel panel, JButton btn) {
		...
		btn_back.setFont(new Font("twayair", Font.BOLD, 25));
