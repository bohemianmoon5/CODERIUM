...
//			setFrame(frame);						
		...
		frame.getContentPane().setFont(new Font(font, Font.BOLD, 20));
...
//		frame.getContentPane().setLayout(null);
		...
		LavelmainRe.setFont(new Font(font, Font.BOLD, 30));
...
//		JButton btn_newReservation = new JButton("새로운 예약");
		...
		btn_newReservation.setFont(new Font(font, Font.BOLD, 25));
...
//				btn_pay.setvisible(false);  => 결제 버튼 비활성화 활성화 하고 싶은데 순서가 문제다 고민해보자,,,!
		...
		btn_checkRe.setFont(new Font(font, Font.BOLD, 25));
		...
		btn_cancelRe.setFont(new Font(font, Font.BOLD, 25));
...
//		frame.getContentPane().add(createNewRe);
		...
		time.setFont(new Font(font, Font.BOLD, 30));
		...
		seat.setFont(new Font(font, Font.BOLD, 30));
		seat.setBounds(10, 775, 200, 80);
		panel.add(seat);

		// 새로운 예약 => 좌석표 선택창 오픈 버튼
		btn_seat = new JButton("좌석 선택");
		btn_seat.setFont(new Font(font, Font.BOLD, 25));
...
//		btn_seat.setBounds(250, 600, 221, 54);
		...
		btn_pay.setFont(new Font(font, Font.BOLD, 25));
			...
			public void actionPerformed(ActionEvent e) {
				if (menu.size() >= 3) {
					JOptionPane.showMessageDialog(null,
							"<html><center><font face = '"+font+"'> 예약 할 수 없습니다. </font></center></html>", "confirm",
...
//					System.out.println(hour);
	...
	public void checkRe(JPanel panel) {
		...
		LabelcheckRe.setFont(new Font(font, Font.BOLD, 30));
...
//		btn_checkIn.setFont(new Font(font, Font.BOLD, 25));
...
//		});
	...
	public void cancelRe(JPanel panel) {
		...
		LabelcancelRe.setFont(new Font(font, Font.BOLD, 30));
...
//		panel.setVisible(true);
		...
		btn_reCancel.setFont(new Font(font, Font.BOLD, 25));
		...
		btn_reCancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int result = JOptionPane.showConfirmDialog(null, "<html><font='"+font+"'>취소하시겠습니까?</font></html>",
...
//				System.out.println("chkBoolggg " + chkBool);
				if (result == JOptionPane.YES_OPTION) {
					...
					if (!chkBool) {
						...
						JOptionPane.showMessageDialog(null, "<html><font='"+font+"'>선택한 버튼이 없습니다.</font></html>",
...
//						System.out.println("res" + result);
						...
						d.delete("paydata", " WHERE Id='" + MainF.user + "' AND StartTime='" + getStart()
								+ "' AND EndTime<='" + getEnd() + "'");
						JOptionPane.showMessageDialog(null, "<html><font='"+font+"'>예약이 취소되었습니다.</font></html>");
						paintData(panel);
...
//    }
	...
	public void btn_back(JPanel panel, JButton btn) {
		...
		btn_back.setFont(new Font(font, Font.BOLD, 25));
